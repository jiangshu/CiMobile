...
<div class="header">
    ...
    <div class="nav">
        <ul>
            ...
            <li style="background-color: #686868;"><a href="filter.php">过滤</a></li>
         ...
         <tr>
             <td>
                 <div style="width:550px;float: left;background: #e2e2e2;padding:10px 0 10px 0">
                     ...
                     <table align="center" cellpadding="15"  width="500" border="1" style=" border-collapse:collapse;table-layout: fixed;word-break: break-all;text-align:center;">
                         <tr>
                             <td bgcolor="#2185ff" style="color:#fff;" width="25%">命令类型</td>
                             <td width="75%">
                                 打开浏览器（目前只支持此命令）
                             </td>
                         </tr>
                         ...
                         <tr>
                             <td bgcolor="#2185ff" style="color:#fff;">系统版本</td>
                         ...
                         <tr>
                             <td bgcolor="#2185ff" style="color:#fff;" >mobile型号</td>
                             <td>
                                 <table width="300px" align="center">
                                     <tr>
                         ...
                         <tr >
                             <td bgcolor="#2185ff" style="color:#fff;">浏览器类型</td>
                             <td>
                                 <table width="300px" align="center">
                                     <tr>
                         ...
                         <tr>
                             <td bgcolor="#2185ff" style="color:#fff;">url</td>
                             <td>
                                 <input type="text" style="width:300px" id="url" name="url_url"/>
                             </td>
                         </tr>
                     </table>
                 </div>
             ...
             <td>
                 <div style="width:550px;float:left;background: #e2e2e2;padding:10px 0 10px 0">
                     ...
                     <div style="width:500px;height:370px;border:1px solid #6c0000;margin-left:auto;margin-right:auto;">
